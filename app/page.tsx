...
export default function Home() {
  return (<main className={`h-screen flex flex-col items-center justify-center gap-y-6`}>
    ...
    <section className="flex flex-col md:flex-row justify-center gap-x-10 gap-y-4 flex-wrap w-1/2 xl:w-1/3 2xl:w-1/5">
      ...
      <Link className="btn-primary flex justify-center gap-x-2" href="https://github.com/visrut-at-incubyte/wizardsurvey.fun" target="_blank">
